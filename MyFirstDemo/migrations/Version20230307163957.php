 ...
 */
final class Version20230307163957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD use_branch_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649A838E549 FOREIGN KEY (use_branch_id) REFERENCES use_branch (id)');
        $this->addSql('CREATE INDEX IDX_8D93D649A838E549 ON user (use_branch_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D649A838E549 ON user');
        $this->addSql('ALTER TABLE user DROP use_branch_id');
    }
}
